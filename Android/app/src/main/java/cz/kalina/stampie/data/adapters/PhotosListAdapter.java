...
public class PhotosListAdapter extends ArrayAdapter<Photo> {
    ...
    public PhotosListAdapter(Context context, User currentUser, List<Photo> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (photo != null) {
            ...
            try {
                ...
                Log.e(PhotosListAdapter.class.getName(), "Error occured when displaying photo item", e);
            }
        }
        return v;
    }
